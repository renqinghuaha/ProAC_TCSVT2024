...
class CustomDatasetDataLoader():
    ...
    def __init__(self, cfg, writer, logger):
        ...
        augmentations_W = cfg['training'].get('augmentations_W', None)
        data_aug_W = get_composed_augmentations(augmentations_W)
        augmentations_S = cfg['training'].get('augmentations_S', None)
        data_aug_S = get_composed_augmentations(augmentations_S)
        self.source_train = source_train(cfg_source, writer, logger, augmentations_W=data_aug_W, augmentations_S=data_aug_S)
        ...
        self.target_train = target_train(cfg_target, writer, logger, augmentations_W=data_aug_W, augmentations_S=data_aug_S, labelpath = cfg['data']['target']['labelpath'])
        #self.target_train = target_train(cfg_target, writer, logger, augmentations_W=data_aug_W, augmentations_S=data_aug_S)
        ...
        if cfg_source_valid != None:
            ...
            self.source_valid = source_valid(cfg_source_valid, writer, logger)
        ...
        if cfg_target_valid != None:
            ...
            self.target_valid = target_valid(cfg_target_valid, writer, logger)
